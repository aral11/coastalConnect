    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <ul style={{ listStyle: 'none', padding: '0' }}>
          <li style={{ padding: '10px', backgroundColor: '#22c55e', color: 'white', margin: '5px 0', borderRadius: '5px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ backgroundColor: '#3b82f6', color: 'white', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
          ...
          <p style={{ margin: '0', fontSize: '18px' }}>45+ Properties Available</p>
        </div>
      ...
      <div style={{ 
        ...
        <p style={{ margin: '5px 0', color: '#6b7280' }}>Current URL: {window.location.href}</p>
        <p style={{ margin: '5px 0', color: '#6b7280' }}>User Agent: {navigator.userAgent.slice(0, 50)}...</p>
        <p style={{ margin: '5px 0', color: '#6b7280' }}>Timestamp: {new Date().toLocaleString()}</p>
        <p style={{ margin: '5px 0', color: '#6b7280' }}>Screen Size: {window.innerWidth} x {window.innerHeight}</p>
      </div>
