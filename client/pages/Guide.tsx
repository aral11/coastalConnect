      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          <p className="text-lg text-gray-700">
            Found <span className="font-semibold text-orange-600">{filteredItems.length}</span> places
        ...
        <div className="bg-gradient-to-r from-orange-50 to-cyan-50 rounded-xl p-8 border border-orange-100">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Your feedback helps us shape the future of CoastalConnect. Tell us what you'd like to see!
            </p>
            <Button
        ...
        <Dialog open={!!selectedItem} onOpenChange={() => setSelectedItem(null)}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <img
                src={selectedItem.image_url || "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600"}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {selectedItem.cuisine_or_type && (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">{selectedItem.cuisine_or_type}</span>
                    </div>
                  )}
                  ...
                  {selectedItem.price_range && (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">{selectedItem.price_range}</span>
                    </div>
                  )}
                </div>
          ...
          <DialogContent className="max-w-md">
            ...
            <form onSubmit={handleFeedbackSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="want_all_in_one" className="text-sm text-gray-700">
                  Yes—bring everything into one platform (bookings, fests, drivers, etc.)
                </label>
              </div>
