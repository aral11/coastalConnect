              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Book authentic homestays, discover local flavors, hire
                    trusted drivers, and connect with talented creators in the
                    heart of Coastal Karnataka.
                  </p>
                </div>
                    ...
                    <button
                      ...
                      onClick={() => {
                        try {
                          ...
                          console.warn(
                            "Failed to track video play event:",
                            error,
                          );
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        try {
                          ...
                          console.warn(
                            "Failed to track favorite event:",
                            error,
                          );
                        }
                      }}
