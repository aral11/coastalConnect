      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <p style={{
            ...
            Your feedback has been received! In Phase 2, this will be saved to our database and help us improve CoastalConnect.
          </p>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "3rem 2rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{
            ...
            Help us build Phase 2 by sharing your thoughts and suggestions about CoastalConnect
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              >
                ...
                <option value="education">Education (Manipal University)</option>
                ...
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      fontSize: "2rem",
                      color: parseInt(formData.rating) >= star ? "#f59e0b" : "#d1d5db",
                      cursor: "pointer",
