    ...
    >
      ...
      <main style={{ padding: "80px 24px" }}>
        ...
        >
          ...
          >
            🎉 SUCCESS! Phase 1 CoastalConnect is now LIVE! No more loading
            screens!
          </div>
          ...
          <div style={{ marginBottom: "48px" }}>
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(45deg, #ea580c, #dc2626, #e11d48)",
          ...
          <div style={{ marginBottom: "80px" }}>
            ...
            >
              {[
                ...
                <a
                  key={index}
                  href={`/guide?category=${category.name.toLowerCase()}`}
                  style={{
                    background: "white",
                    borderRadius: "16px",
                    padding: "24px",
      ...
      >
        ...
        >
          <div>
            ...
            >
              Your trusted companion for exploring the beautiful coastal region
              of Udupi & Manipal.
            </p>
          </div>
