...
export default function Phase1Guide() {
  ...
  const samplePlaces = [
    ...
    },
    {
      ...
      description: "Popular beach with water sports and boat rides to St. Mary's Island",
    ...
    },
    {
      ...
      category: "festivals",
      description: "Grand celebration at Sri Krishna Matha with cultural programs",
      location: "Udupi",
      rating: "4.9",
      image: "🎉"
    }
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{
            ...
            Explore the best places, restaurants, and experiences in coastal Karnataka
          </p>
        </div>
          ...
          {categories.map((category) => (
            <button
              ...
              style={{
                ...
                border: "2px solid #e5e7eb",
                borderColor: activeCategory === category.id ? "#3b82f6" : "#e5e7eb",
        ...
        {filteredPlaces.length === 0 && (
          <div style={{
            ...
            <h3 style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>No places found</h3>
        ...
        <div style={{
          ...
          <p style={{
            ...
            This is a working Phase 1 guide with sample data. Connect to Supabase to load real places and enable full functionality!
          </p>
        </div>
      </div>
    </div>
