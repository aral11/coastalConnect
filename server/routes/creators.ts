...
const mockCreators: Creator[] = [
  {
    ...
    profile_image: "https://ui-avatars.com/api/?name=Shutterbox+Films&size=200&background=4F46E5&color=FFFFFF&bold=true&format=png",
    cover_image: "",
  ...
  },
  {
    ...
    profile_image: "https://ui-avatars.com/api/?name=Priya+Coastal+Arts&size=200&background=EC4899&color=FFFFFF&bold=true&format=png",
    cover_image: "",
  ...
  },
  {
    ...
    profile_image: "https://ui-avatars.com/api/?name=Coastal+Flavor+Stories&size=200&background=F59E0B&color=FFFFFF&bold=true&format=png",
    cover_image: "",
  ...
  },
  {
    ...
    profile_image: "https://ui-avatars.com/api/?name=Beach+Vibes+Karnataka&size=200&background=0EA5E9&color=FFFFFF&bold=true&format=png",
    cover_image: "",
  ...
  },
  {
    ...
    profile_image: "https://ui-avatars.com/api/?name=Udupi+Traditions&size=200&background=10B981&color=FFFFFF&bold=true&format=png",
    cover_image: "",
...
function getCoverImage(username: string): string {
  // Return empty string - we'll use CSS gradients instead of dummy images
  return '';
}
